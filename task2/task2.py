...
if __name__ == "__main__":
    ...
    for file_name in file_list:
        ...
        # street_name
        df_street = df.where(
            col(col_name).like("%STREET%") | col(col_name).like("%AVE%") | col(col_name).like("%PLACE%") | col(
                col_name).like("%ROAD%") | \
            col(col_name).like("%COURT%") | col(col_name).like("%DRIV%") | col(col_name).like("%PARK%") | col(
                col_name).like("%LANE%") | \
            col(col_name).like("%TERRACE%") | col(col_name).like("%WEST%") | col(col_name).like("%SOUTH%") | col(
                col_name).like("%EAST%") | \
        ...
        # website
        df_website = df.where(
            col(col_name).like("%ORG%") | col(col_name).like("%PORTAL%") | col(col_name).like("%GOV%") | col(col_name).like(
                "%COM%") | \
        ...
        df_building = df.where(
            col(col_name).like("%WALK%") | col(col_name).like("%ELEVATOR%") | col(col_name).like("%CONDOPS%"))
        ...
        # borough
        df_borough = df.where(
            col(col_name).like("M") | col(col_name).like("K") | col(col_name).like("Q") | col(col_name).like("R") | \
            col(col_name).like("X") | col(col_name).like("%MANHAT%") | col(col_name).like("%QUEEN%") | col(col_name).like(
                "%BROO%") | \
        ...
        # person_name
        df_person = df.where(
            col(col_name).like("%H_M%") | col(col_name).like("%R_N%") | col(col_name).like("%A_B%") | col(col_name).like("A_D%") | \
        ...
        # business_name
        df_business = df.where(
            col(col_name).like("%RESTAURANT%") | col(col_name).like("%PIZZ%") | col(col_name).like("%CAFE%") | col(col_name).like("%DELI%") | \
        ...
        # address
        df_address = df.where(
            col(col_name).like("%STREET%") | col(col_name).like("%AVE%") | col(col_name).like("%PLACE%") | col(col_name).like("%ROAD%") | \
        ...
        # neighborhood
        df_neighborhood = df.where(
            col(col_name).like("%ARROCHAR%") | col(col_name).like("%DONGAN%") | col(col_name).like("%GRANT%") | col(col_name).like("%GRYMES%") | \
        ...
        # school_name
        df_school = df.where(
            col(col_name).like("%PUBLIC%") | col(col_name).like("%SCHOOL%") | col(col_name).like("%CHILDREN%") | col(col_name).like("%ACADEMY%") | \
        ...
        # color
        df_color = df.where(
            col(col_name).like("BLK%") | col(col_name).like("BLU%") | col(col_name).like("RED%") | col(col_name).like("%RD%") | \
        ...
        # car_make
        df_car = df.where(
            col(col_name).like("VOL%") | col(col_name).like("%AC_%") | col(col_name).like("%AE_%") | col(col_name).like("%AD_%") | \
        ...
        # city_agency
        df_agency = df.where(
            col(col_name).like("311") | col(col_name).like("ACS") | col(col_name).like("BIC") | col(col_name).like("BOE") | col(col_name).like("BPL") | \
        ...
        # area_of_study
        df_study = df.where(
            col(col_name).like("%SCIENCE%") | col(col_name).like("%DESIGN%") | col(col_name).like("%ARTS%") | col(
                col_name).like("%PERFORMING%") | \
            col(col_name).like("%TEACH%") | col(col_name).like("%COMMUNI%") | col(col_name).like("%ARCHITECT%") | col(
                col_name).like("%TECHNO%") | \
            col(col_name).like("%HOSPITALITY%") | col(col_name).like("%HUMANIT%") | col(col_name).like("%MATH%") | col(
                col_name).like("%HEALTH%") | \
            col(col_name).like("%ENVIRON%") | col(col_name).like("%INTEREST%") | col(col_name).like("%GOVERNMENT%") | col(
                col_name).like("%COMPUTER%") | \
        ...
        # subject_in_school
        df_subject = df.where(
            col(col_name).like("%ALGEBRA%") | col(col_name).like("%CHEM%") | col(col_name).like("%BIO%") | col(
                col_name).like("%MATH%") | \
            col(col_name).like("%ECO%") | col(col_name).like("%ENG%") | col(col_name).like("%GEO%") | col(col_name).like(
                "%GLO%") | \
            col(col_name).like("%ENV%") | col(col_name).like("%PHY%") | col(col_name).like("%GOV%") | col(col_name).like(
                "%HIST%"))
        ...
        # school_level
        df_school_level = df.where(
            col(col_name).like("%SCHOOL%") | col(col_name).like("%ELEMENTARY%") | col(col_name).like("%HIGH%") | col(
                col_name).like("KINDER%") | \
        ...
        # vehicle_type
        df_vehicle_type = df.where(
            col(col_name).like("4__") | col(col_name).like("2_") | col(col_name).like("2__") | col(col_name).like("2___") | \
        ...
        # park_playground
        df_playground = df.where(
            col(col_name).like("%SCHOOL%") | col(col_name).like("%PARK%") | col(col_name).like("%PLAYGROUND%") | col(
                col_name).like("%HIGH%") | \
            col(col_name).like("%CENTER%") | col(col_name).like("%POOL%") | col(col_name).like("%RECREATION%") | col(
                col_name).like("%CENTRAL%") | \
            col(col_name).like("%BEACH%") | col(col_name).like("%FIELD%") | col(col_name).like("%PROSPECT%") | col(
                col_name).like("%ACADEMY%") | \
        ...
        label_list_data = {
            ...
            "building_classification": [building_perct, building_count],
            "borough": [borough_perct,borough_count],
            "person_name": [person_perct, person_count],
            "address": [address_perct, address_count],
            "city": [city_perct, city_count],
            "color": [color_perct, color_count],
            "lat_lon_cord": [cord_perct, cord_count],
            "neighbourhood": [neighbor_perct, neighbor_count],
            "school_level": [school_level_perct, school_level_count],
            "school_name": [school_perct, school_level_count],
            "school_subject": [school_subject_perct,school_subject_count],
            "street": [street_perct,street_count],
            "vehicle_type": [vehicle_type_perct,vehicle_type_count],
        ...
        label_list = {
            ...
            "area_of_study": "area_of_study, subject_in_school",
            "subject_in_school": "area_of_study , subject_in_school",
